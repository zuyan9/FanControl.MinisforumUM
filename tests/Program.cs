...
internal static class Program
{
    ...
    {
        foreach (string biosVersion in new[] { "1.08", "1.09" })
        {
            HostIdentitySnapshot exact = F7bsiHost("F7BSI", "MGF7BSI", biosVersion);
            ...
            [
                ...
                exact with { BiosVersion = "1.10" },
                exact with { BiosVersion = "1.9" },
