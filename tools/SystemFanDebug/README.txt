Minisforum system-fan diagnostics
...
Press Ctrl+C to stop early and restore control; keep the window open until cleanup finishes.
Supports the UM-series board/EC profiles recognized by the MinisforumUM plugin.
Other machines are identified in the log and rejected before EC access.
